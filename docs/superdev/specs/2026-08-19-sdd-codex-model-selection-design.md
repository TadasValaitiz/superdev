...
|---|----------------------------------|--------|------|--------------------------|
| AH1 | An ordinary native Claude implementation can be routed through SDD at the medium tier without a Codex dependency. | UC1 / R1, R3, R4 | fast | Structural GREEN: `SddModelSelectionTests.test_core_skill_links_two_tier_codex_appendix_and_preserves_claude` (`tests/codex-worker/test_skill_integration.py:196-207`); native `medium`/`sonnet` and no-daemon contract at `skills/subagent-driven-development/SKILL.md:120-138`. [Semantic checkpoint PASS](../reviews/2026-08-19-sdd-model-selection-semantic-checkpoint.md:10). |
| AH2 | An ordinary Codex implementation resolves the medium tier to Terra after validating the live model and effort. | UC2 / R1, R2, R4, R5 | fast | Structural GREEN: `SddModelSelectionTests.test_codex_appendix_defines_only_sol_and_terra_tier_mappings` (`tests/codex-worker/test_skill_integration.py:209-214`) and `test_codex_appendix_requires_live_effort_validation_and_no_fallback` (`tests/codex-worker/test_skill_integration.py:216-230`); Terra mapping and live validation at `skills/subagent-driven-development/codex-model-selection.md:10-13, 27-33, 40-44`. [Semantic checkpoint PASS](../reviews/2026-08-19-sdd-model-selection-semantic-checkpoint.md:12). |
| AH3 | Main-session brainstorming/design stays on Claude `opus`, while a dispatched high-judgment review or gate resolves the mandatory very-smart tier to Claude `opus` or Codex Sol according to the explicitly selected mechanism. | UC3 / R2, R3, R4 | fast | Structural GREEN: `SddModelSelectionTests.test_core_skill_links_two_tier_codex_appendix_and_preserves_claude` (`tests/codex-worker/test_skill_integration.py:196-207`); native main-session and dispatch split at `skills/subagent-driven-development/SKILL.md:123-138`, Sol mapping at `skills/subagent-driven-development/codex-model-selection.md:10-13, 47-54`. [Semantic checkpoint PASS](../reviews/2026-08-19-sdd-model-selection-semantic-checkpoint.md:15). |
| AH4 | A reader can explain Sol versus Terra and pin model plus effort using the focused appendix, without a third tier or unrelated-model catalog. | UC4 / R2, R5, R6, R7 | fast | Structural GREEN: `SddModelSelectionTests.test_codex_appendix_defines_only_sol_and_terra_tier_mappings` (`tests/codex-worker/test_skill_integration.py:209-214`) and `test_codex_appendix_requires_live_effort_validation_and_no_fallback` (`tests/codex-worker/test_skill_integration.py:216-230`); focused distinction/pinning at `skills/subagent-driven-development/codex-model-selection.md:10-20, 35-77`. [Semantic checkpoint PASS—Terra](../reviews/2026-08-19-sdd-model-selection-semantic-checkpoint.md:12) and [Sol](../reviews/2026-08-19-sdd-model-selection-semantic-checkpoint.md:15). |
| AH5 | Missing pinned models and unsupported efforts stop with an explicit, actionable blocker rather than silent substitution. | UC5 / R5 | fast | Structural GREEN: `SddModelSelectionTests.test_codex_appendix_requires_live_effort_validation_and_no_fallback` (`tests/codex-worker/test_skill_integration.py:216-230`); explicit block/no-substitution at `skills/subagent-driven-development/codex-model-selection.md:30-33`. [Semantic checkpoint PASS](../reviews/2026-08-19-sdd-model-selection-semantic-checkpoint.md:19). |
| AH6 | If native Claude lacks the required `opus` or `sonnet` alias, dispatch stops with an explicit blocker rather than silently collapsing to the other tier. | UC1, UC3 / R3, R4 | fast | Structural GREEN: `SddModelSelectionTests.test_core_skill_links_two_tier_codex_appendix_and_preserves_claude` (`tests/codex-worker/test_skill_integration.py:196-207`); native alias blocker at `skills/subagent-driven-development/SKILL.md:131-133`. [Semantic checkpoint PASS](../reviews/2026-08-19-sdd-model-selection-semantic-checkpoint.md:10). |
