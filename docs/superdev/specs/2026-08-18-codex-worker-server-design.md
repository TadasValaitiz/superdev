...
| AH8 | A real worker writes and runs a hello-world app that creates a file, and another worker performs a different code task in another worktree; filesystem and command evidence match the prompts. | UC7 / R8–R10 | live | `python3 tests/codex-worker/live_broker_check.py --scenario concurrent-worktrees` · `.superdev/codex-worker-live/20260818T220024.791233Z-7494-concurrent-worktrees/transcript.jsonl` |
