...
**Mode:** human-in-loop
**Decision log:** ./2026-08-24-system-design-layer-decisions.md (D1–D33; the arbitration surface is the addendum **plus each entry's own revisit-when**)
