...
|---|----------------------------------|--------|------|--------------------------|
| AH1 | Claude starts a named worker with no callback boilerplate and receives the complete successful report without polling, inline or through a verified artifact reference. | UC1 / R1–R3 | live checkride | **MEASURED:** `.superdev/codex-worker-live/20260820T142608Z-45432-claude-caller/{claude.stream.jsonl,validated-common-evidence.json}`; automatic IDs recovered, PATH-only commands, full result, no MCP/raw Codex. Synthetic live corroboration: `20260820T141214.365903Z-13986-callback-common/transcript.jsonl`. |
| AH2 | A follow-up launched from different ambient Claude metadata still reports to the worker's original room. | UC1, UC6 / R2, R8 | fast + live | **MEASURED:** `.superdev/codex-worker-live/20260820T141313.706567Z-18257-callback-origin-retention/transcript.jsonl`; replacement then unset ambient metadata, three origin-only terminal IDs. |
| AH3 | Codex proactively tells Claude something during an active turn, continues working, and accepts a later steer/run response. | UC2 / R4, R6 | live checkride | **MEASURED:** `.superdev/codex-worker-live/20260820T141247.315360Z-16824-callback-proactive/transcript.jsonl`; written proactive ID, accepted steer, later run terminal. Exactly-five concurrency: `20260820T141706.873425Z-29231-callback-five-workers/transcript.jsonl`. |
| AH4 | One proactive message reaches an explicitly named alternate Claude agent while the eventual terminal callback still reaches the origin. | UC3 / R2, R5, R9 | live checkride | **MEASURED:** `20260820T141247.315360Z-16824-callback-proactive/transcript.jsonl`; one alternate frame, origin terminal/default follow-up frames. |
...
| AH6 | Standalone and explicitly callback-disabled workers retain the ordinary worker experience with honest callback state. | UC4 / R1, R11 | fast + live | **MEASURED:** `20260820T141214.365903Z-13986-callback-common/transcript.jsonl` records enabled/disabled/unavailable full completions and redacted states. |
...
| AH9 | Both stdlib probes send versioned events to `orchestrator-original`, whose append-only pongs correlate by event ID. | UC7 / R12 | live probe | Trading worktree commits `4ce3fd0a..3302175a` on `codex-worker-callback-probes`; **MEASURED** pongs seq 3/4 at `/Users/tadas/Projects/ai-ethics/ai-trading-calibration/.superdev/brainstorm/codex-worker-claude-callback-ping-pong.jsonl`. |
