...
- Visual weight of the Claude Code section (which has two sub-sections — official Anthropic marketplace and Superdev marketplace). Both are real install paths; collapsing them would hide accurate info.
