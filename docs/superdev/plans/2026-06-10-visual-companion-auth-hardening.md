...
```bash
cd /Users/drewritter/prime-rad/superdev/tests/brainstorm-server
node auth.test.js
```
...
```bash
cd /Users/drewritter/prime-rad/superdev
...
```bash
cd /Users/drewritter/prime-rad/superdev
git check-ignore .superdev/brainstorm/.last-token || true
```
...
```bash
cd /Users/drewritter/prime-rad/superdev
git check-ignore .superdev/brainstorm/.last-token
```

Expected output:

```text
.superdev/brainstorm/.last-token
```
...
```bash
node /tmp/superdev-pr1720-security-drewritter/probe-pr1720.cjs
```
