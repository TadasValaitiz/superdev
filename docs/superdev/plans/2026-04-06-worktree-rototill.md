...
**Goal:** Make superdev defer to native harness worktree systems when available, fall back to manual git worktrees when not, and fix three known finishing bugs.
...
**Spec:** `docs/superdev/specs/2026-04-06-worktree-rototill-design.md`
