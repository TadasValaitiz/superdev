...
> **For agentic workers:** REQUIRED: Use superdev:subagent-driven-development (if subagents available) or superdev:executing-plans to implement this plan.
...
**Spec:** docs/superdev/specs/2026-01-22-document-review-system-design.md
...
```markdown
> **For agentic workers:** REQUIRED: Use superdev:subagent-driven-development (if subagents available) or superdev:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
