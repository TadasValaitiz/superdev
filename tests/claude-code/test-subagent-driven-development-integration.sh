...
mkdir -p src test docs/superdev/plans

# Create a simple implementation plan
cat > docs/superdev/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/superdev/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/superdev/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"superdev:subagent-driven-development"' "$SESSION_FILE"; then
