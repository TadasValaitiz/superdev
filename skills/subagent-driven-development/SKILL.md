...
2. If the task requires more reasoning, re-dispatch at the `very smart` tier
...
You: "User level (~/.config/superdev/hooks/)"
...
- **superdev:using-git-worktrees** - Ensures isolated workspace (creates one or verifies existing)
- **superdev:writing-plans** - Creates the plan this skill executes
- **superdev:requesting-code-review** - Code review template for the final whole-branch review
- **superdev:finishing-a-development-branch** - Complete development after all tasks

**Subagents should use:**
- **superdev:test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**
- **superdev:executing-plans** - Use for parallel session instead of same-session execution
